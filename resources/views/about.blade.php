    ...
    <div class="about-intro-area">
        <div class="container position-relative h-100 d-flex align-items-center">
            ...
            <div class="intro-left">
                <img src="{{ asset('fronted') }}/images/about-image/intro-left.png" alt="" class="intro-left-image">
            </div>
            <div class="intro-right">
                <img src="{{ asset('fronted') }}/images/about-image/intro-right.png" alt="" class="intro-right-image">
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 d-flex">
                    <div class="service-left align-self-center align-items-center">
                        <img src="{{ asset('fronted') }}/images/about-image/srevice-left-img.png" alt="" class="service-left-image">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-lm-30px">
                    ...
                    <div class="team-wrapper">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('fronted') }}/images/team/1.jpg" alt="">
                        </div>
                ...
                <div class="col-md-4 mb-lm-30px">
                    ...
                    <div class="team-wrapper">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('fronted') }}/images/team/2.jpg" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-md-4">
                    ...
                    <div class="team-wrapper">
                        <div class="team-image overflow-hidden">
                            <img src="{{ asset('fronted') }}/images/team/3.jpg" alt="">
                        </div>
                        <div class="team-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature border-0">
                        <div class="feature-icon">
                            <img src="{{ asset('fronted') }}/images/icons/1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                    <div class="single-feature border-0">
                        <div class="feature-icon">
                            <img src="{{ asset('fronted') }}/images/icons/2.png" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-md-6 ">
                    <div class="single-feature border-0">
                        <div class="feature-icon">
                            <img src="{{ asset('fronted') }}/images/icons/3.png" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('fronted') }}/images/testimonial-image/1.png" alt="">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('fronted') }}/images/testimonial-image/2.png" alt="">
                                </div>
                                <div class="author-name">
                    ...
                    <div class="swiper-slide">
                        <div class="testi-inner">
                            ...
                            <div class="testi-author">
                                <div class="author-img">
                                    <img src="{{ asset('fronted') }}/images/testimonial-image/3.png" alt="">
                                </div>
                                <div class="author-name">
            ...
            <div class="brand-slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('fronted') }}/images/brand-logo/1.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('fronted') }}/images/brand-logo/2.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('fronted') }}/images/brand-logo/3.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('fronted') }}/images/brand-logo/4.png" alt="" /></a>
                    </div>
                    <div class="swiper-slide brand-slider-item text-center">
                        <a href="#"><img class=" img-fluid" src="{{ asset('fronted') }}/images/brand-logo/5.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
