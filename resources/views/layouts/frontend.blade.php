...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{ asset('fronted') }}/images/favicon/favicon.ico" type="image/png">

    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet">
    <!-- vendor css (Icon Font) -->
    <!-- <link rel="stylesheet" href="{{ asset('fronted') }}/css/vendor/bootstrap.bundle.min.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/vendor/pe-icon-7-stroke.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/vendor/font.awesome.css" /> -->

    <!-- plugins css (All Plugins Files) -->
    <!-- <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/animate.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/swiper-bundle.min.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/jquery-ui.min.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/nice-select.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/venobox.css" /> -->

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="{{ asset('fronted') }}/css/style.min.css">
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('index') }}"><img src="{{ asset('fronted') }}/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                ...
                                <li class="dropdown "><a href="{{ route('team') }}">Blogs</a></li>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            {{-- <a href="login.html" class="header-action-btn login-btn" data-bs-toggle="modal"
                                ...
                                @guest
                                <a href="{{ route('customerlogin') }}" class="header-action-btn login-btn">Log In</a>
                                @else
                                <a href="{{ route('customer.dashboard') }}" class="header-action-btn login-btn text-success">{{ auth()->user()->name }}, Go to Dashboard</a>
                                @endguest
                            ...
                            {{-- <a href="{{ route('cart')}}" --}}
                                class="header-action-btn header-action-btn-cart offcanvas-toggle pr-0"><i class="pe-7s-shopbag"></i>
                ...
                <ul class="minicart-product-list">
                    ...
                    @empty
                        <tr>
                            ...
                            <h2 class="text-danger">No Cart Item to Show</h2>
                            </td>
                        </tr>
                    @endforelse --}}
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('fronted') }}/images/logo/logo-white.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{ asset('fronted') }}/images/icons/payment.png" alt="" class="payment-img img-fulid">
    ...
    <!-- Vendor JS -->
    <!-- <script src="{{ asset('fronted') }}/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="{{ asset('fronted') }}/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('fronted') }}/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="{{ asset('fronted') }}/js/vendor/modernizr-3.11.2.min.js"></script> -->

    <!--Plugins JS-->
    <!-- <script src="{{ asset('fronted') }}/js/plugins/swiper-bundle.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/jquery-ui.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/jquery.nice-select.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/countdown.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/scrollup.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/jquery.zoom.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/venobox.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/ajax-mail.js"></script> -->

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script src="{{ asset('fronted') }}/js/vendor/vendor.min.js"></script>
    <script src="{{ asset('fronted') }}/js/plugins/plugins.min.js"></script>
    ...
    <script type="text/javascript">
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/627911277b967b11798e755b/1g2kem1it';
            s1.charset='UTF-8';
