...
<head>
    ...
    <link href="{{ asset('my_style.css') }}" rel="stylesheet">
</head>
<body>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('upload/profile_photo') }}/{{ auth()->user()->profile_photo }}" width="20" alt=""/>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('slider.index') }}" aria-expanded="false">
                        <i class="fab fa-affiliatetheme"></i>Slider</a>
                    </li>
                    <li><a href="{{ route('feature.index') }}" aria-expanded="false">
                        <i class="fas fa-dolly-flatbed"></i>Feature</a>
                    </li>
                    ...
                    <li><a href="{{ route('variation') }}" aria-expanded="false">
                        <i class="fas fa-th"></i>Variation Manager</a>
                    </li>
                    <li><a href="{{ route('shipping') }}" aria-expanded="false">
                        <i class="fa fa-car"></i>Shipping Charge</a>
                    </li>
                    <li><a href="{{ route('coupon') }}" aria-expanded="false">
                        <i class="fa fa-percent"></i>Coupon Charge</a>
                    </li>
                    <li><a href="{{ route('orders') }}" aria-expanded="false">
                        <i class="fa fa-file-word-o"></i>Orders
                    </a>
                    </li>

                    <li><a class=" ai-icon" href="{{ route('index') }}" target="_blank" aria-expanded="false">
                        <i class="fa fa-globe"></i>
                        <span class="nav-text">Visite Website</span>
                    </a>
                    </li>
                </ul>
